...
declare const Client: typeof IgniteClient & import("./helpers").Constructor<{
    ...
    CiferCifer: {
        query: import("./cifer.cifer/rest").Api<unknown>;
        tx: {
            sendParams({ value, fee, memo }: {
                value: import("./cifer.cifer/module").Params;
                fee?: import("@cosmjs/amino").StdFee;
                memo?: string;
            }): Promise<import("@cosmjs/stargate").DeliverTxResponse>;
            sendMsgUpdateParamsResponse({ value, fee, memo }: {
                value: import("./cifer.cifer/module").MsgUpdateParamsResponse;
                fee?: import("@cosmjs/amino").StdFee;
                memo?: string;
            }): Promise<import("@cosmjs/stargate").DeliverTxResponse>;
            sendMsgUpdateParams({ value, fee, memo }: {
                value: import("./cifer.cifer/module").MsgUpdateParams;
                fee?: import("@cosmjs/amino").StdFee;
                memo?: string;
            }): Promise<import("@cosmjs/stargate").DeliverTxResponse>;
            sendGenesisState({ value, fee, memo }: {
                value: import("./cifer.cifer/module").GenesisState;
                fee?: import("@cosmjs/amino").StdFee;
                memo?: string;
            }): Promise<import("@cosmjs/stargate").DeliverTxResponse>;
            sendQueryParamsRequest({ value, fee, memo }: {
                value: import("./cifer.cifer/module").QueryParamsRequest;
                fee?: import("@cosmjs/amino").StdFee;
                memo?: string;
            }): Promise<import("@cosmjs/stargate").DeliverTxResponse>;
            sendQueryParamsResponse({ value, fee, memo }: {
                value: import("./cifer.cifer/module").QueryParamsResponse;
                fee?: import("@cosmjs/amino").StdFee;
                memo?: string;
            }): Promise<import("@cosmjs/stargate").DeliverTxResponse>;
            params({ value }: {
